...
const tabs = [
...

  {
    ...
    content: (
      <p>
        My mission is to create AI systems that <strong>empower people</strong>{' '}
        and scale responsibly. I aim to contribute to impactful projects,
        research collaborations, and open-source communities shaping the future
        of AI.
      </p>
    ),
  },
